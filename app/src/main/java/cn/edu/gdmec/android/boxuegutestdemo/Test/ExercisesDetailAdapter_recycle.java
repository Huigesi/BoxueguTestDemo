...
public class ExercisesDetailAdapter_recycle extends RecyclerView.Adapter<ExercisesDetailAdapter_recycle.ViewHolder> {
    ...
    public ExercisesDetailAdapter_recycle(Context context, OnSelectListener onSelectListener) {
  ...
  /*  @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        initializeViews((ExercisesBean) getItem(position), (ViewHolder) convertView.getTag(), position);
        return convertView;
    }*/
